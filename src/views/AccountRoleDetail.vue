      ...
      <div class="left-content">
        ...
        <div class="manager-info">
          <div class="manager-info-row">
            <el-text style="width: 45px;margin-left: 15px;"><el-text style="color:#ff0000">*</el-text>账号:</el-text>
            <el-input style="width: 250px;" v-model="account" placeholder="请输入">
            </el-input>
          </div>
          <div class="manager-info-row">
            <el-text style="width: 45px;margin-left: 15px;"><el-text style="color:#ff0000">*</el-text>密码:</el-text>
            <el-input style="width: 250px;" v-model="passwd" type="text" minlength="6" placeholder="密码不少于六位">
            </el-input>
          </div>
          <div class="manager-info-row">
            <el-text style="width: 40px;margin-left: 20px;"><el-text style="color:#ff0000">*</el-text>电话:</el-text>
            <el-input style="width: 250px;" v-model="phoneNumber" placeholder="请输入">
            </el-input>
          </div>
          <div class="manager-info-row">
            <el-text style="width: 40px;margin-left: 20px;">备注:</el-text>
            <el-input style="width: 250px;" v-model="remark" placeholder="请输入">
            </el-input>
          </div>
          <div style="margin-top: 5px;margin-left: 60px;">
            <el-text size="small">请在右侧设置权限, 确认后点击'确认新建'</el-text>
          </div>
        </div>
      </div>
    </div>
